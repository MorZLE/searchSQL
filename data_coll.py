...
def data_collection():
    ...
    try:
        match vendr[res]:
            ...
            case 'MySQL':
                print('Шаблон строки подключения для MySQL:Server=<server>;'
            ...
            case 'MSserver':
                ...
                print('Шаблон строки подключения для MSserver: Server=serverName;'
                      'UID=UserName;PWD=Password;Database=My_DW;')
